function z = myInvNormCDF(p)
% Description : Calculates inverse normal cumulative distribution function.
%               Probability that random # in normal distribution is > than z = p.
%               Found this online.
