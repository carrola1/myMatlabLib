...
static const char * c1_debug_family_names[4] = { "nargin", "nargout", "phase",
  "i_channel_data" };
  ...
  *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_i_channel_data, 3U,
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4113393890U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1058063449U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(557055356U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(868108320U);
}
...
mxArray *sf_c1_ProposedGaussian_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3915393206U);
    pr[1] = (double)(3953831699U);
    pr[2] = (double)(1050228199U);
    pr[3] = (double)(2060463205U);
...
static void mdlSetWorkWidths_c1_ProposedGaussian(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3232438890U));
  ssSetChecksum1(S,(2472242936U));
  ssSetChecksum2(S,(3074519769U));
  ssSetChecksum3(S,(1048963610U));
