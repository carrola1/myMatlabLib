...
static const char * c4_debug_family_names[8] = { "nargin", "nargout", "Bit",
  "LastBit", "LastAccum", "LastRand", "randOut", "accum" };

/* Function Declarations */
static void initialize_c4_ProposedGaussian(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
static void initialize_params_c4_ProposedGaussian
  (SFc4_ProposedGaussianInstanceStruct *chartInstance);
static void enable_c4_ProposedGaussian(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
static void disable_c4_ProposedGaussian(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_ProposedGaussian
  (SFc4_ProposedGaussianInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_ProposedGaussian
  (SFc4_ProposedGaussianInstanceStruct *chartInstance);
static void set_sim_state_c4_ProposedGaussian
  (SFc4_ProposedGaussianInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_ProposedGaussian(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
static void sf_c4_ProposedGaussian(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
static void initSimStructsc4_ProposedGaussian
  (SFc4_ProposedGaussianInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_ProposedGaussianInstanceStruct
  *chartInstance, const mxArray *c4_accum, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_ProposedGaussianInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_ProposedGaussianInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_ProposedGaussianInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_ProposedGaussian, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_ProposedGaussianInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_ProposedGaussianInstanceStruct
  *chartInstance);
  ...
  (SFc4_ProposedGaussianInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_accum = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "accum");
  *c4_randOut = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "randOut");
  chartInstance->c4_is_active_c4_ProposedGaussian = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_ProposedGaussian");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_ProposedGaussian(chartInstance);
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = *c4_b_Bit;
  c4_b_hoistedGlobal = *c4_b_LastBit;
  c4_c_hoistedGlobal = *c4_b_LastAccum;
  c4_d_hoistedGlobal = *c4_b_LastRand;
  c4_Bit = c4_hoistedGlobal;
  c4_LastBit = c4_b_hoistedGlobal;
  c4_LastAccum = c4_c_hoistedGlobal;
  c4_LastRand = c4_d_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_Bit, 2U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_LastBit, 3U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_LastAccum, 4U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_LastRand, 5U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_randOut, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_accum, 7U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_ProposedGaussianInstanceStruct *chartInstance;
  chartInstance = (SFc4_ProposedGaussianInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c4_accum, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_accum), &c4_thisId);
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_accum;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_ProposedGaussianInstanceStruct *chartInstance;
  chartInstance = (SFc4_ProposedGaussianInstanceStruct *)chartInstanceVoid;
  c4_accum = sf_mex_dup(c4_mxArrayInData);
...
const mxArray *sf_c4_ProposedGaussian_get_eml_resolved_functions_info(void)
{
  ...
  (*c4_b_info)[0].fileTimeLo = 529702400U;
  (*c4_b_info)[0].fileTimeHi = 30114350U;
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_ProposedGaussian), &c4_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1975398998U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2154741213U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1600275550U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2620477026U);
}
...
mxArray *sf_c4_ProposedGaussian_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(4117993488U);
    pr[1] = (double)(2130643665U);
    pr[2] = (double)(1277948631U);
    pr[3] = (double)(3431970578U);
...
static const mxArray *sf_get_sim_state_info_c4_ProposedGaussian(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_ProposedGaussianInstanceStruct *chartInstance;
    chartInstance = (SFc4_ProposedGaussianInstanceStruct *) ((ChartInfoStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(_ProposedGaussianMachineNumber_,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"Bit");
          _SFD_SET_DATA_PROPS(1,1,1,0,"LastBit");
          _SFD_SET_DATA_PROPS(2,1,1,0,"LastAccum");
          _SFD_SET_DATA_PROPS(3,1,1,0,"LastRand");
          _SFD_SET_DATA_PROPS(4,2,0,1,"randOut");
          _SFD_SET_DATA_PROPS(5,2,0,1,"accum");
...
{
  chart_debug_initialization(((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar);
  initialize_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_ProposedGaussian(void *chartInstanceVar)
{
  enable_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_ProposedGaussian(void *chartInstanceVar)
{
  disable_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_ProposedGaussian(void *chartInstanceVar)
{
  sf_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_ProposedGaussian(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_ProposedGaussian
    ((SFc4_ProposedGaussianInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_ProposedGaussian();/* state var info */
...
extern void sf_internal_set_sim_state_c4_ProposedGaussian(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_ProposedGaussian(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_ProposedGaussian(S);
}

static void sf_opaque_set_sim_state_c4_ProposedGaussian(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_ProposedGaussian(S, st);
}

static void sf_opaque_terminate_c4_ProposedGaussian(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ProposedGaussianInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_ProposedGaussian((SFc4_ProposedGaussianInstanceStruct*)
    chartInstanceVar);
}
...
static void mdlSetWorkWidths_c4_ProposedGaussian(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ProposedGaussian","ProposedGaussian",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ProposedGaussian","ProposedGaussian",4,
                "RTWCG"));
  ...
  ssSetChecksum0(S,(2807765391U));
  ssSetChecksum1(S,(4096401554U));
  ssSetChecksum2(S,(1946347524U));
  ssSetChecksum3(S,(1715092898U));
...
{
  SFc4_ProposedGaussianInstanceStruct *chartInstance;
  chartInstance = (SFc4_ProposedGaussianInstanceStruct *)malloc(sizeof
    (SFc4_ProposedGaussianInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_ProposedGaussianInstanceStruct));
