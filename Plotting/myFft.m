function [freq, dataOut] = myFft(data,fs,numAvg,units,plotOn)
...
%               averages fft of each. Uses hann window.
%
...
freq    = fs/2*linspace(0,1,NFFT/2+1)./range;
dataOut = 10*log10(YAvg(1:NFFT/2+1));
if plotOn == 1
    figure
    plot(freq,dataOut) 
