...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3467430103U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3545985611U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3105243924U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1467756102U);
}
...
mxArray *sf_c2_ProposedGaussian_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(4108395010U);
    pr[1] = (double)(1210473325U);
    pr[2] = (double)(4277822754U);
    pr[3] = (double)(2797344350U);
...
static void mdlSetWorkWidths_c2_ProposedGaussian(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3774320781U));
  ssSetChecksum1(S,(972725913U));
  ssSetChecksum2(S,(1985707143U));
  ssSetChecksum3(S,(1129202963U));
